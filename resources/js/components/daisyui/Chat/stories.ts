...
import { CHAT_PLACEMENTS } from "./types";
...
const meta: Meta<typeof Chat> = {
  ...
  argTypes: {
    items: {
      control: "object",
      description: "Array of chat items with message, image, header, footer, placement and color properties",
    },
    placement: {
      control: { type: "select" },
  ...
  args: {
    items: [
      ...
      {
        message: "Of course, I would be happy to help with that. What is your question?",
        header: "Assistant",
...
<div class="flex flex-col gap-2">
  <Chat>
    ...
    <ChatItem placement="end" variant="secondary">
      <template #image>
        <img src="https://img.daisyui.com/images/stock/photo-1534528741775-53994a69daeb.webp" alt="Avatar" />
      </template>
      <template #header>
