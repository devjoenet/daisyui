...
import { ref } from "vue";
import { TOAST_HORIZONTAL_POSITIONS, TOAST_VERTICAL_POSITIONS } from "./types";
...
const meta: Meta<typeof Toast> = {
  ...
  argTypes: {
    horizontalPosition: {
      control: { type: "select" },
      options: [...TOAST_HORIZONTAL_POSITIONS, undefined],
      description: "Horizontal position of the toast",
    },
    verticalPosition: {
      control: { type: "select" },
      options: [...TOAST_VERTICAL_POSITIONS, undefined],
