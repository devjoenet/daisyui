<script setup lang="ts">
  ...
  import { type RatingItemProps, type RatingItemEmits } from "./types";
...
<template>
  <input type="radio" :name="ratingName" :class="maskClass" :checked="checked" @click="handleChange" :disabled="disabled" :aria-label="`${value} star`" />
</template>
