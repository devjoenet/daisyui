<script setup lang="ts">
  ...
  const svgIcon = computed(() => {
    if (props.icon) {
      if (props.variant === "default" || props.variant === "success" || props.variant === "error" || props.variant === "warning" || props.variant === "info") {
...
<template>
  <div :class="['badge', sizeClass, colorClass, softClass, outlineClass, dashClass, ghostClass]">
