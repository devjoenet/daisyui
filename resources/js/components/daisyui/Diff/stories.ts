...
const differentAspectRatiosTplStr = `
...
export const DifferentAspectRatios: Story = {
  ...
  parameters: {
    docs: {
      source: {
        code: differentAspectRatiosTplStr,
        language: "html",
      },
    },
  },
...
const withColorBackgroundsTplStr = `
...
export const WithColorBackgrounds: Story = {
  ...
  parameters: {
    docs: {
      source: {
        code: withColorBackgroundsTplStr,
        language: "html",
      },
    },
  },
