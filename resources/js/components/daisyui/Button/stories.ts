...
<div class="flex gap-2 items-center">
    ...
    <button variant="error" soft>Error</button>
</div>
`;
...
<div class="flex gap-2 items-center">
    ...
    <button variant="info" dash>Info</button>
    <button variant="success" dash>Success</button>
    <button variant="warning" dash>Warning</button>
    <button variant="error" dash>Error</button>
</div>
`;
...
const DisabledButtonTplStr = `
  <button :disabled="true">Disabled using attribute</button>
`;
...
<div class="inline-flex flex-col gap-4 justify-center">
  ...
  <!-- Facebook -->
  <button class="bg-[#1A77F2] text-white border-[#005fd8]">
