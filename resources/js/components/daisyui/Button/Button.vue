...
<template>
  <component :is="elementTag" v-bind="buttonAttributes" :class="['btn', customClass, sizeClass, colorClass, softClass, outlineClass, dashClass, activeClass, ghostClass, linkClass, wideClass, squareClass, circleClass, blockClass]" :aria-label="props.label" :disabled="props.disabled">
