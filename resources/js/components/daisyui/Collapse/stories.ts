...
const meta = {
  ...
  argTypes: {
    items: {
      control: "object",
      description: "Array of collapse items with title, content, open and customClass properties",
    },
    modifier: {
      control: { type: "select" },
    ...
    items: [
      {
        ...
        content: "This is the first collapse content. It can contain any HTML content.",
        open: true,
      },
      {
        title: "Click to open this one and close others",
        content: "This is the second collapse content. It can contain any HTML content.",
        open: false,
      },
      {
        title: "Click to open this one and close others",
        content: "This is the third collapse content. It can contain any HTML content.",
        open: false,
      },
    ],
    ...
    items: [
      {
        ...
        content: "This collapse is open by default because the 'open' property is set to true.",
        open: true,
      },
      {
        title: "This one is closed by default",
        content: "This collapse is closed by default because the 'open' property is set to false.",
        open: false,
      },
    ],
    modifier: "collapse-arrow",
