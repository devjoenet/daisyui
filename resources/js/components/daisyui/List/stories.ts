...
export const ThirdColumnGrows: Story = {
  render: (args: any) => ({
    ...
    template: thirdColumnGrowsTplStr,
  }),
  parameters: {
    docs: {
      source: {
        code: thirdColumnGrowsTplStr,
        language: "html",
      },
    },
  },
...
export const WithListColWrap: Story = {
  render: () => ({
    components: { List, ListRow },
    template: withListColWrapTplStr,
  }),
  parameters: {
    docs: {
      source: {
        code: withListColWrapTplStr,
        language: "html",
      },
    },
  },
